...
public class SignUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonSignUp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final String fullname, username, password, email, contact;
                ...
                if (!fullname.equals("") && !username.equals("") && !password.equals("") && !email.equals("") && !contact.equals("")) {
                    ...
                    handler.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            data[3] = email;
                            data[4] = contact;
                            PutData putData = new PutData("http://192.168.137.1/login-signup/signup.php", "POST", field, data);
                            if (putData.startPut()) {
